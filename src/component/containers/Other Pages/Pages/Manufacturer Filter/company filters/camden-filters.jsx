...
class camdenFilter extends Component {
    constructor() {
        super();
        this.state={
    ...
    render() {
        ...
        const filteredProducts = products.filter(product =>
            product.name.toLowerCase().includes(searchField.toLowerCase()) && product.company === 'Camden'
            ) 
        ...
        return (
            <div className="products-filter-page">
                ...
                <div className="product-filters-header">
                       ...
                       <h2>Filter by Camden</h2>
                       <h3 className="product-subheader">Access Direct is proud to carry multiple Camden products.</h3>
                </div>
                    ...
                    <div className="products-flexed">

                       {
                        filteredProducts.map(product => 
                            ...
                            <img alt="Camden's products" className="images-products-render" src={product.image}/>
