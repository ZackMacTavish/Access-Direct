...
class regentFilter extends Component {
    constructor() {
        super();
        this.state={
    ...
    render() {
        ...
        const filteredProducts = products.filter(product =>
            product.name.toLowerCase().includes(searchField.toLowerCase()) && product.company === 'Regent'
            ) 
        ...
        return (
            <div className="products-filter-page">
                ...
                <div className="product-filters-header">
                       ...
                       <h2>Filter by Regent</h2>
                       <h3 className="product-subheader">Access Direct is proud to carry multiple Regent products.</h3>
                </div>
                    ...
                    <div className="products-flexed">

                       {
                        filteredProducts.map(product => 
                            ...
                            <img alt="Regent's products" className="images-products-render" src={product.image}/>
