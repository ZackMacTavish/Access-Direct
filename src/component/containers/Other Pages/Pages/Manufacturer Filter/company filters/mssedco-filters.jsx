...
class mssedcoFilter extends Component {
    constructor() {
        super();
        this.state={
    ...
    render() {
        ...
        const filteredProducts = products.filter(product =>
            product.name.toLowerCase().includes(searchField.toLowerCase()) && product.company === 'MS Sedco'
            ) 
        ...
        return (
            <div className="products-filter-page">
                ...
                <div className="product-filters-header">
                       ...
                       <h2>Filter by MS Sedco</h2>
                       <h3 className="product-subheader">Access Direct is proud to carry multiple MS Sedco products.</h3>
                </div>
