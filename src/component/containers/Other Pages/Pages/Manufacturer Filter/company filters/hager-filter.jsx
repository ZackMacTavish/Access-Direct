...
class hagerFilter extends Component {
    constructor() {
        super();
        this.state={
    ...
    render() {
        ...
        const filteredProducts = products.filter(product =>
            product.name.toLowerCase().includes(searchField.toLowerCase()) && product.company === 'Hager'
            ) 
                    ...
                    <div className="products-flexed">

                       {
                        filteredProducts.map(product => 
                            ...
                            <img alt="Hager's products" className="images-products-render" src={product.image}/>
